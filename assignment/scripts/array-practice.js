...
let favoriteFoods = ['sushi', 'pasta', 'ramen'];

console.log('What I like to eat:', favoriteFoods);
...
console.log('last animal in array', lastAnimal);
...
console.log('dessert array', dessert);

favoriteFoods.push(dessert);

console.log('added dessert to favorite food array', favoriteFoods);
...
console.log('unshift method', favoriteFoods);
...
console.log('current colors are', colors);
let lastColor = [];

lastColor = colors.pop();

console.log(' after pop(), the last color is', lastColor);
...
console.log('shift() used:', firstColor);

console.log('now we have 2 colors', colors);
